...
void on_enregistrerslaj_clicked(GtkWidget *button,
                                gpointer user_data)
{
}

void on_retourslaj_clicked(GtkWidget *button,
                           gpointer user_data)
{
}

void on_quitterslaj_clicked(GtkWidget *button,
                            gpointer user_data)
{
   GtkWidget *Affichage;
    GtkWidget *show;
    Affichage = lookup_widget(button, "sirinebenlakhdhar_ajout");
    gtk_widget_hide(Affichage);
     
}

void on_retourslmd_clicked(GtkWidget *button,
                           gpointer user_data)
{
}

void on_enregistrerslmd_clicked(GtkWidget *button,
                                gpointer user_data)
{
}

void on_quitterslmd_clicked(GtkWidget *button,
                            gpointer user_data)
{
    GtkWidget *Affichage;
    GtkWidget *show;
    Affichage = lookup_widget(button, "sirinebenlakhdhar_modification");
    gtk_widget_hide(Affichage);
}

void on_supprimergs_clicked(GtkWidget *button,
                            gpointer user_data)
{
    GtkWidget *Affichage;
    GtkWidget *show;
    show = create_sirine_ben_lakhdhar_suppression();
    gtk_widget_show(show);
}

void on_modifiergs_clicked(GtkWidget *button,
                           gpointer user_data)
{
    GtkWidget *Affichage;
    GtkWidget *show;
    show = create_sirinebenlakhdhar_modification();
    gtk_widget_show(show);
}

void on_ajoutergs_clicked(GtkWidget *button,
                          gpointer user_data)
{
    GtkWidget *Affichage;
    GtkWidget *show;
    show = create_sirinebenlakhdhar_ajout();
    gtk_widget_show(show);
}

void on_retourbv_clicked(GtkWidget *button,
                         gpointer user_data)
{
    GtkWidget *Affichage;
    GtkWidget *show;
    Affichage = lookup_widget(button, "sirinebenlakhdhar_gestion");
    gtk_widget_hide(Affichage);
    show = create_Admin();
    gtk_widget_show(show);
}

void on_quitterbv_clicked(GtkWidget *button,
                          gpointer user_data)
{
    GtkWidget *Affichage;
    GtkWidget *show;
...
void on_admin_login_clicked(GtkWidget *button,
                            gpointer user_data)
{
    Admin a;
    ...
    GtkWidget *input_log;
    GtkWidget *input_mdp;
    input_mdp = lookup_widget(button, "admin_auth_mdp_entry");
    input_log = lookup_widget(button, "admin_auth_login_entry");
    ...
    if (auth(a, admin, id) == 1)
    {
        ...
        GtkWidget *treeview;
        convert();
        authentification = lookup_widget(button, "authentification_admin");
        gtk_widget_hide(authentification);
        Affichage = lookup_widget(button, "Admin");
...
void on_electeur_login_clicked(GtkWidget *button,
                               gpointer user_data)
{
}

void on_observateur_login_clicked(GtkWidget *button,
                                  gpointer user_data)
{
}

void on_agentbv_login_clicked(GtkWidget *button,
                              gpointer user_data)
{
}
...
void on_agentbv_auth_choix_clicked(GtkWidget *button,
                                   gpointer user_data)
{
    GtkWidget *admin;
    GtkWidget *choix;
...
void on_observateur_auth_choix_clicked(GtkWidget *button,
                                       gpointer user_data)
{
    GtkWidget *admin;
    GtkWidget *choix;
...
void on_admin_deco_button_clicked(GtkWidget *button,
                                  gpointer user_data)
{
    GtkWidget *Affichage;
    GtkWidget *authentification;
...
void on_gestion_utilisateur_button_clicked(GtkWidget *button,
                                           gpointer user_data)
{
    GtkWidget *Affichage;
    GtkWidget *show;
...
void on_gestion_election_button_clicked(GtkWidget *button,
                                        gpointer user_data)
{
}

void on_gestion_bv_button_clicked(GtkWidget *button,
                                  gpointer user_data)
{
    GtkWidget *affichage;
    GtkWidget *affichage2;
    GtkWidget *treeview;
    affichage=create_sirinebenlakhdhar_gestion();
    gtk_widget_show(affichage);
    affichage2=lookup_widget(button, "Admin");
    gtk_widget_hide(affichage2);
    treeview=lookup_widget(affichage, "gestionbv");
    afficherbv(treeview);
}

void on_liste_electorale_button_clicked(GtkWidget *button,
                                        gpointer user_data)
{
}

void on_vote_button_clicked(GtkWidget *button,
                            gpointer user_data)
{
}

void on_electeur_deco_button_clicked(GtkWidget *button,
                                     gpointer user_data)
{
}

void on_observateur_deco_button_clicked(GtkWidget *button,
                                        gpointer user_data)
{
}

void on_gestion_reclamation_button_clicked(GtkWidget *button,
                                           gpointer user_data)
{
}

void on_agentbv_deco_button_clicked(GtkWidget *button,
                                    gpointer user_data)
{
}
...
void on_fares_frini_ajout_button_clicked(GtkWidget *button,
                                         gpointer user_data)
{
    GtkWidget *ajout;
...
void on_fares_frini_modifier_button_clicked(GtkWidget *button,
                                            gpointer user_data)
{
    {
        for (int i = 0; i < 6; i++)
...
void on_fares_frini_raffraichir_button_clicked(GtkWidget *button,
                                               gpointer user_data)
{

    GtkWidget *afficher, *w1;
    GtkWidget *treeview;
    w1 = lookup_widget(button, "fares_frini_Affichage");
...
void on_fares_frini_quitter_button_clicked(GtkWidget *button,
                                           gpointer user_data)
{
    GtkWidget *Affichage;
    GtkWidget *show;
    Affichage = lookup_widget(button, "fares_frini_Affichage");
    gtk_widget_hide(Affichage);
    show = create_Admin();
    gtk_widget_show(show);
}

void on_fares_frini_supprimer_button_clicked(GtkWidget *button,
                                             gpointer user_data)
{
    GtkWidget *conf;
...
void on_fares_frini_stat_clicked(GtkWidget *button,
                                 gpointer user_data)
{
    GtkWidget *conf;
...
void on_fares_frini_recherche_button_clicked(GtkWidget *button,
                                             gpointer user_data)
{
    char cin[10], date[20];
    char nom[10];
    ...
    case 0:
        ...
        entry1 = lookup_widget(button, "fares_frini_entry_recherche");
        ...
        break;
    case 1:
        entry2 = lookup_widget(button, "fares_frini_entry_recherche");
        ...
        break;
    case 2:
        entry3 = lookup_widget(button, "fares_frini_entry_recherche");
    ...
    case 4:
        ...
        break;
    case 5:
        pjour = lookup_widget(button, "fares_frini_chercher_jour_spin");
        pmois = lookup_widget(button, "fares_frini_chercher_mois_spin");
        pannee = lookup_widget(button, "fares_frini_chercher_annee_spin");
...
void on_fares_frini_appliquer_bv_button_clicked(GtkWidget *button,
                                                gpointer user_data)
{
    char bv[10];
    int ibv, R;
    GtkWidget *combobox;
    combobox = lookup_widget(button, "combobox2");
...
void on_fares_frini_ajouter_button_clicked(GtkWidget *button,
                                           gpointer user_data)
{
    ...
    GtkWidget *mois;
    GtkWidget *annee;
    jour = lookup_widget(button, "fares_frini_jour_spin");
    mois = lookup_widget(button, "fares_frini_mois_spin");
    annee = lookup_widget(button, "fares_frini_annee_spin");
    input_nom = lookup_widget(button, "fares_frini_ajouter_nom_entry");
    input_prenom = lookup_widget(button, "fares_frini_prenom_entry");
    input_cin = lookup_widget(button, "fares_frini_ajouter_cin_entry");
    ...
    if (verifierajout(p, filename) == 1)
    {
        ...
        gtk_widget_show(conf);
        ajout = lookup_widget(button, "fares_frini_ajouter");
    ...
    {
        GtkWidget *output;
        output = lookup_widget(button, "fares_frini_ajouter_erreur_label");
...
void on_fares_frini_modifier_modifier_button_clicked(GtkWidget *button,
                                                     gpointer user_data)
{
    if (choixmodif[1] == 1)
    {
    ...
    GtkWidget *cont4;
    cont4 = lookup_widget(button, "fares_frini_modifier");
...
void on_confirmer_supp_supp_button_clicked(GtkWidget *button,
                                           gpointer user_data)
{
    ...
    Afficher_Personne(treeview);
    GtkWidget *cont4;
    cont4 = lookup_widget(button, "fares_frini_confirmer_supp");
    gtk_widget_hide(cont4);
}

void on_fares_frini_confirmer_annuler_button_clicked(GtkWidget *button,
                                                     gpointer user_data)
{
}

void on_fares_frini_confirmer_modifier_button_clicked(GtkWidget *button,
                                                      gpointer user_data)
{
}

void on_fares_frini_continuer_button_clicked(GtkWidget *button,
                                             gpointer user_data)
{
    GtkWidget *cont;
    cont = lookup_widget(button, "fares_frini_resultat_ajout_echec");
    gtk_widget_hide(cont);
    GtkWidget *cont2;
    cont2 = lookup_widget(button, "fares_frini_ajout_succ");
    gtk_widget_hide(cont2);
    GtkWidget *cont3;
    cont3 = lookup_widget(button, "fares_frini_auth_echec");
    gtk_widget_hide(cont3);
    GtkWidget *cont5;
    cont5 = lookup_widget(button, "fares_frini_resultat_supp_succ");
    gtk_widget_hide(cont5);
    GtkWidget *cont6;
    cont6 = lookup_widget(button, "fares_frini_resultat_supp_echec");
    gtk_widget_hide(cont6);
}

void on_fares_frini_valider_modif_nom_clicked(GtkWidget *button,
                                              gpointer user_data)
{
    ...
    GtkWidget *input_nom;
    GtkWidget *cont4;
    input_nom = lookup_widget(button, "fares_frini_nom_modif_entry");
    strcpy(nom, gtk_entry_get_text(GTK_ENTRY(input_nom)));
    R = modifierprenom(nom, filename);
    cont4 = lookup_widget(button, "fares_frini_modif_nom");
    gtk_widget_hide(cont4);
}

void on_fares_frini_modif_prenom_button_clicked(GtkWidget *button,
                                                gpointer user_data)
{
    char nom[20], filename[20] = "utilisateur.txt";
    int R;
    GtkWidget *input_nom;
    GtkWidget *cont4;
    input_nom = lookup_widget(button, "fares_frini_prenom_modif_entry");
    strcpy(nom, gtk_entry_get_text(GTK_ENTRY(input_nom)));
    R = modifierprenom(nom, filename);
    cont4 = lookup_widget(button, "fares_frini_modif_prenom");
    gtk_widget_hide(cont4);
}

void on_fares_frini_valider_modif_age_button_clicked(GtkWidget *button,
                                                     gpointer user_data)
{
    char filename[20] = "utilisateur.txt";
    ...
    GtkWidget *mois;
    GtkWidget *annee;
    jour = lookup_widget(button, "fares_frini_modif_jour_spin");
    mois = lookup_widget(button, "fares_frini_modif_mois_spin");
    annee = lookup_widget(button, "fares_frini_modif_annee_spin");
    ...
    GtkWidget *cont4;
    cont4 = lookup_widget(button, "fares_frini_modif_age");
    gtk_widget_hide(cont4);
}
...
void on_fares_frini_valider_modif_sexe_clicked(GtkWidget *button,
                                               gpointer user_data)
{
    char filename[20] = "utilisateur.txt";
    int R;
    ...
    GtkWidget *cont4;
    cont4 = lookup_widget(button, "fares_frini_modif_sexe");
    gtk_widget_hide(cont4);
}
...
void on_fares_frini_modif_etat_valider_clicked(GtkWidget *button,
                                               gpointer user_data)
{
    char filename[20] = "utilisateur.txt";
    int R;
    ...
    GtkWidget *cont4;
    cont4 = lookup_widget(button, "fares_frini_modif_etat");
    gtk_widget_hide(cont4);
}

void on_confirmer_ajout_button_clicked(GtkWidget *button,
                                       gpointer user_data)
{
    Utilisateur p;
    int R = 0;
    ...
    if (R)
    {
        ...
        gtk_widget_show(ajout);
        GtkWidget *conf;
        conf = lookup_widget(button, "fares_frini_confirmer_ajout");
    ...
    GtkWidget *conf;
    conf = lookup_widget(button, "confirmer_ajout");
    gtk_widget_hide(conf);
}

void on_confirmer_annuler_button_clicked(GtkWidget *button,
                                         gpointer user_data)
{
}
...
void on_button12_clicked(GtkWidget *button,
                         gpointer user_data)
{
}

void on_button13_clicked(GtkWidget *button,
                         gpointer user_data)
{
}

void on_button14_clicked(GtkWidget *button,
                         gpointer user_data)
{
}

void on_button17_clicked(GtkWidget *button,
                         gpointer user_data)
{
}

void on_button18_clicked(GtkWidget *button,
                         gpointer user_data)
{
}

void on_button15_clicked(GtkWidget *button,
                         gpointer user_data)
{
}

void on_btnsup_clicked(GtkWidget *button,
                       gpointer user_data)
{
}

void on_refrech_btn_clicked(GtkWidget *button,
                            gpointer user_data)
{
}
...
void on_button10_clicked(GtkWidget *button,
                         gpointer user_data)
{
}

void on_button11_clicked(GtkWidget *button,
                         gpointer user_data)
{
}

void on_button19_clicked(GtkWidget *button,
                         gpointer user_data)
{
}
...
void on_button20_clicked(GtkWidget *button,
                         gpointer user_data)
{
}

void on_calculertph_clicked(GtkWidget *button,
                            gpointer user_data)
{
}

void on_calculertpe_clicked(GtkWidget *button,
                            gpointer user_data)
{
}

void on_calculertpf_clicked(GtkWidget *button,
                            gpointer user_data)
{
}

void on_button21_clicked(GtkWidget *button,
                         gpointer user_data)
{
}

void on_Annuler__clicked(GtkWidget *button,
                         gpointer user_data)
{
    GtkWidget *Affichage;
    GtkWidget *show;
    Affichage = lookup_widget(button, "sirine_ben_lakhdhar_suppression");
    gtk_widget_hide(Affichage);
}

void on_buttonsupp_clicked(GtkWidget *button,
                           gpointer user_data)
{
}

void on_confirmer_clicked(GtkWidget *button,
                          gpointer user_data)
{
}

void on_Retour__clicked(GtkWidget *button,
                        gpointer user_data)
{
}

void on_fares_frini_recherche_valider_clicked(GtkWidget *button,
                                              gpointer user_data)
{
    GtkWidget *combobox;
    combobox = lookup_widget(button, "critere_recherche");
    ...
    if (strcmp("Date De Naissance", gtk_combo_box_get_active_text(GTK_COMBO_BOX(combobox))) == 0)
    {
        ...
        GtkWidget *jour, *mois, *annee;
        GtkWidget *entry, *radio1, *radio2, *radio3, *radio4;
        jour = lookup_widget(button, "fares_frini_chercher_jour_spin");
        gtk_widget_show(jour);
        mois = lookup_widget(button, "fares_frini_chercher_mois_spin");
        gtk_widget_show(mois);
        annee = lookup_widget(button, "fares_frini_chercher_annee_spin");
        gtk_widget_show(annee);
        entry = lookup_widget(button, "fares_frini_entry_recherche");
        gtk_widget_hide(entry);
        radio1 = lookup_widget(button, "fares_frini_chercher_electeur");
        gtk_widget_hide(radio1);
        radio2 = lookup_widget(button, "fares_frini_chercher_agentbv");
        gtk_widget_hide(radio2);
        radio3 = lookup_widget(button, "fares_frini_chercher_homme");
        gtk_widget_hide(radio3);
        radio4 = lookup_widget(button, "fares_frini_chercher_femme");
        gtk_widget_hide(radio4);
    }
    else
    {
